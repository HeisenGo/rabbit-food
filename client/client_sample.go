...
func main() {
	...
	//_, err = conn.Write([]byte(`{"location":"auth/register","header":{"method":"POST"},"data":{"phone":"09123456789","email":"kih123@gk.co","password":"AliJaf@123"}}`))
	...
	_, err = conn.Write([]byte(`{"location":"user/createaddresses","header":{"method":"POST","Authorization": "Bearer eyJhbGciOiJIUzUxMiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3MTk1MzcxMjAsIlVzZXJJRCI6MSwiSXNBZG1pbiI6ZmFsc2V9.RQCfYqZ7Zpb-GgyNSmDC5-c1xA0AJqmfHnnVsy4xN_2ACA2tih8_IklmIaglUmiUohpBq-T6pOCUFxqHs_m5Jw"},"data":{"address_line":"abcd","cordinates":[123, 546],"types":"User","city":"tehran"}}`))
