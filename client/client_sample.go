...
func main() {
	...
	_, err = conn.Write([]byte(`{"location":"users/addresses","header":{"method":"POST","Authorization": "Bearer eyJhbGciOiJIUzUxMiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3MTk2MTkwMTgsIlVzZXJJRCI6MSwiSXNBZG1pbiI6ZmFsc2V9.pFtCYAutcHfOfMlQjnYfkeRi4GvMT4mUtaDF8yQubvPC4JI9Cbn6sSN8G-FHe6a9L0akYJCQgs6CapIBdiR5sg"},"data":{"address_line":"borje milad","coordinates":{"lat":35.7448, "lng":51.3755},"city":"tehran"}}`))
