...
func main() {
	...
	//_, err = conn.Write([]byte(`{"location":"auth/register","header":{"method":"POST"},"data":{"phone":"09337307958","email":"jasem@yahoo.com","password":"Jaf@123"}}`))
	...
	_, err = conn.Write([]byte(`{"location":"user/createaddresses","header":{"method":"POST","Authorization": "Bearer eyJhbGciOiJIUzUxMiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3MTk1OTU3NDYsIlVzZXJJRCI6MiwiSXNBZG1pbiI6ZmFsc2V9.8QyDxw78oJdMzf8KG6ewd6dMtGjeVuQRH0TDXq0L3hudPFdbA_i-4-BV2g5468i41m30NOL9akmGhuurDVQWZw"},"data":{"address_line":"abcd","cordinates":[123, 546],"types":"User","city":"tehran"}}`))
